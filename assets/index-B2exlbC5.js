 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $A=5*60,qA=gy("authIdTokenMaxAge")||$A;let uy=null;const WA=i=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>qA)return;const o=t==null?void 0:t.token;uy!==o&&(uy=o,await fetch(i,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function HA(i=Ey()){const e=Md(i,"auth");if(e.isInitialized())return e.getImmediate();const t=f1(i,{popupRedirectResolver:FA,persistence:[Y1,U1,mv]}),s=gy("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const h=WA(u.toString());x1(t,h,()=>h(t.currentUser)),O1(t,f=>h(f))}}const o=py("auth");return o&&m1(t,`http://${o}`),t}function GA(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}s1({loadJS(i){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=o=>{const u=Un("internal-error");u.customData=o,t(u)},s.type="text/javascript",s.charset="UTF-8",GA().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});BA("Browser");const KA={apiKey:"AIzaSyCfrj364XdQGKkX0gsNA2l0LWs1JJSaQ1I",authDomain:"moody-e6de7.firebaseapp.com",projectId:"moody-e6de7",storageBucket:"moody-e6de7.firebasestorage.app"},kf=vy(KA),wi=HA(kf),QA=new Er,YA=hS(kf),ls=cS(YA,"posts");kf.options.projectId;const XA=async(i,e,t)=>{if(!i.body.trim()||!t){alert("Write about your feelling and select your mood emoji");return}console.log(t);const s=wi.currentUser;try{await kS(ls,{...i,uid:s.uid,createdAt:DS(),mood:t}),e({body:""})}catch(o){console.error("Error adding post:",o)}},JA=async i=>{try{const e=of(ls,i);await PS(e)}catch(e){console.error("Error deleting post:",e)}},ZA=async(i,e)=>{try{const t=of(ls,i);await CS(t,{body:e})}catch(t){console.error("Error updating post:",t)}},cy=(i,e)=>{const t=fc(ls,Zn("uid","==",i.uid),mc("createdAt","desc"));return gc(t,o=>{const u=o.docs.map(h=>({id:h.id,...h.data()}));e(u)})},eR=(i,e)=>{const t=new Date,s=new Date;t.setHours(0,0,0,0),s.setHours(23,59,59,999);const o=fc(ls,Zn("uid","==",i.uid),Zn("createdAt",">=",t),Zn("createdAt","<=",s),mc("createdAt","desc"));return gc(o,h=>{const f=h.docs.map(g=>({id:g.id,...g.data()}));e(f)})},tR=(i,e)=>{const t=new Date,s=new Date;t.setDate(t.getDate()-7),s.setDate(s.getDate());const o=fc(ls,Zn("uid","==",i.uid),Zn("createdAt",">=",t),Zn("createdAt","<=",s),mc("createdAt","desc"));return gc(o,h=>{const f=h.docs.map(g=>({id:g.id,...g.data()}));e(f)})},nR=(i,e)=>{const t=new Date,s=new Date;t.setDate(t.getDate()-30),s.setDate(s.getDate());const o=fc(ls,Zn("uid","==",i.uid),Zn("createdAt",">=",t),Zn("createdAt","<=",s),mc("createdAt","desc"));return gc(o,h=>{const f=h.docs.map(g=>({id:g.id,...g.data()}));e(f)})},rR=(i,e,t)=>{if(e!=null)switch(i){case"Today":eR(e,t);break;case"Week":tR(e,t);break;case"Month":nR(e,t);break;case"All":cy(e,t);default:cy(e,t);break}},Iv=(i="all-filter-btn",e,t)=>hv(wi,o=>{e(u=>u.map(h=>{if(h.id===i){const f={...h,selected:"selected-filter"};return rR(h.value,o,t),f}else return{...h,selected:""}}))}),iR=(i,e,t,s,o)=>hv(wi,h=>{if(h){e(!0),i(v=>({...v,name:h.displayName,email:h.email,photoURL:h.photoURL,successMessage:"",errorMessage:""}));let g=o.find(v=>v.selected==="selected-filter").id;Iv(g,s,t)}else e(!1),i(f=>({...f,name:"",email:"",password:"",photoURL:"./images/default-profile-picture.jpeg",errorMessage:"",successMessage:""}))}),sR=async i=>{try{const e=await tA(wi,QA),{email:t}=e.user;i(s=>({...s,email:t,successMessage:"Google sign-in successful!",errorMessage:""}))}catch{i(t=>({...t,errorMessage:"Failed to sign in with Google. Please try again."}))}},oR=async(i,e)=>{try{await N1(wi,i.email,i.password),e(t=>({...t,successMessage:"Sign-in successful!",errorMessage:""}))}catch(t){e(s=>({...s,errorMessage:t.message,successMessage:""}))}},aR=async(i,e)=>{try{const s=(await k1(wi,i.email,i.password)).user;e(o=>({...o,successMessage:`Account created successfully for ${s.email}`,errorMessage:""}))}catch(t){e(s=>({...s,errorMessage:t.message,successMessage:""}))}},lR=i=>{L1(wi).then(()=>{i(e=>({...e,name:"",email:"",password:"",photoURL:"./images/default-profile-picture.jpeg",errorMessage:"",successMessage:""}))}).catch(e=>{console.error("Error signing out:",e)})},uR=(i,e)=>{if(!e.name&&!e.photoURL)return;const t={displayName:e.name,photoURL:e.photoURL};V1(wi.currentUser,t).then(()=>{i(s=>({...s,photoURL:t.photoURL,name:t.displayName}))}).catch(s=>{console.error("Error updating profile:",s)})};function cR({updatedUser:i,handleUpdateProfile:e,handleUpdateProfileChange:t,closeModal:s}){return ne.jsx("div",{className:"modal-overlay",children:ne.jsxs("div",{className:"modal update-profile",children:[ne.jsx("button",{className:"close-btn",onClick:s,children:"x"}),ne.jsx("h2",{children:"Update Profile"}),ne.jsxs("label",{for:"name",children:[" Full Name",ne.jsx("input",{id:"name",type:"text",value:i.name,onChange:t,placeholder:"John Doe",required:!0})]}),ne.jsxs("label",{for:"photoURL",children:[" Profile Picture Link",ne.jsx("input",{id:"photoURL",type:"text",value:i.photoURL,onChange:t,placeholder:"https://example.com/profile-picture.jpg",required:!0})]}),ne.jsx("button",{className:"primary-btn",onClick:e,children:"Update"})]})})}function hR({handleNewPostChange:i,handleAddPost:e,newPost:t}){return ne.jsxs("div",{className:"post-section",children:[ne.jsx("textarea",{id:"body",placeholder:"Write down how you're feeling...",value:t.body,onChange:i}),ne.jsx("button",{id:"post-btn",className:"primary-btn",onClick:e,children:"Post"})]})}function dR({user:i,onSignOut:e,updatedUser:t,handleUpdateProfile:s,handleUpdateProfileChange:o,handleAddPost:u,handleDeletePost:h,handleUpdatePost:f,handleUpdatePostChange:g,handleNewPostChange:v,handleMoodClick:w,posts:C,newPost:x,mood:j,displayFormatedDate:G,replaceNewLines:Q,filterBtns:$,handleFilterBtnClick:fe,editingPost:pe,updateEditingPost:ge}){const[we,Fe]=ln.useState(!1),Te=()=>Fe(!we),N=j.map(R=>ne.jsxs("button",{id:R.id,className:`mood-emoji-btn ${R.selected}`,onClick:w,children:[ne.jsx("img",{src:R.imgUrl,alt:`An ${R.name} face emoji`}),R.name]},R.id)),I=C.map(R=>ne.jsxs("div",{className:"post",children:[ne.jsxs("div",{className:"header",children:[R.createdAt?ne.jsx("h3",{children:G(R.createdAt)}):"Processing date...",ne.jsx("img",{src:`./emojis/${R.mood}.png`})]}),ne.jsxs("p",{children:[" ",Q(R.body)," "]}),ne.jsxs("div",{className:"footer",children:[ne.jsx("button",{onClick:()=>ge(R.id,R.body),className:"edit-color","aria-pressed":pe.id===R.id,children:"Edit"}),ne.jsx("button",{onClick:()=>h(R.id),className:"delete-color",children:"Delete"})]})]},R.id)),A=$.map(R=>ne.jsx("button",{id:R.id,className:`${R.id.split("-")[1]}-btn ${R.selected}`,onClick:fe,"aria-pressed":R.selected,children:R.value},R.id));return ne.jsx("section",{id:"logged-in-view",children:ne.jsxs("div",{className:"container",children:[ne.jsxs("nav",{children:[ne.jsx("button",{className:"update-profile-btn scale secondary-btn",onClick:Te,children:"Update Profile"}),ne.jsx("button",{className:"sign-out-btn scale",onClick:e,children:ne.jsx("img",{src:"./icons/icon-sign-out.svg",className:"icon-img-btn",alt:"Sign out icon"})})]}),ne.jsx("div",{className:"app-container",children:ne.jsxs("div",{className:"user-section",children:[ne.jsx("img",{id:"user-profile-picture",src:i.photoURL,alt:`${i.name?i.name:"User"}'s profile picture`}),ne.jsxs("h2",{id:"user-greeting",children:["Hello, ",i.name?i.name.split(" ")[0]:"my friend","! How are you?"]})]})}),ne.jsx("div",{className:"mood-emojis",children:N}),ne.jsx(hR,{handleNewPostChange:v,handleAddPost:u,newPost:x}),ne.jsxs("div",{className:"filters-and-posts-section",children:[ne.jsx("div",{className:"filters-section",children:A}),ne.jsx("div",{className:"posts-section",children:C.length>0?I:ne.jsx("p",{children:"No Posts Available"})})]}),pe.show&&ne.jsx("div",{className:"modal-overlay",children:ne.jsxs("div",{className:"modal edit-post-section",children:[ne.jsx("textarea",{id:"body",placeholder:"Tell others how you're feeling...",value:pe.body,onChange:g}),ne.jsx("button",{onClick:f,children:"Update Post"})]})}),we&&ne.jsx(cR,{updatedUser:t,handleUpdateProfile:s,handleUpdateProfileChange:o,closeModal:Te})]})})}function fR({user:i,handleSignIn:e,handleCreateAccount:t,handleChange:s}){return ne.jsxs("div",{className:"auth-fields-and-buttons",children:[ne.jsx("input",{id:"email",type:"email",placeholder:"example@gmail.com",value:i.email,onChange:s,required:!0}),ne.jsx("input",{id:"password",type:"password",placeholder:"*******",value:i.password,onChange:s,required:!0}),i.errorMessage&&ne.jsx("p",{style:{color:"red"},children:i.errorMessage}),i.successMessage&&ne.jsx("p",{style:{color:"green"},children:i.successMessage}),ne.jsx("button",{id:"sign-in-btn",className:"primary-btn",onClick:e,children:"Sign in"}),ne.jsx("button",{id:"create-account-btn",className:"secondary-btn",onClick:t,children:"Create Account"})]})}function pR({onGoogleSignIn:i}){return ne.jsx("div",{className:"provider-buttons",children:ne.jsxs("button",{id:"sign-in-with-google-btn",className:"provider-btn",onClick:i,children:[ne.jsx("img",{src:"./providers/google.png",alt:"Google logo",className:"google-btn-logo"}),"Sign in with Google"]})})}function mR({onGoogleSignIn:i,handleSignIn:e,handleCreateAccount:t,handleChange:s,user:o}){return ne.jsx("div",{id:"logged-out-view",children:ne.jsxs("div",{className:"container",children:[ne.jsx("h1",{className:"app-title",children:"Moody"}),ne.jsx(pR,{onGoogleSignIn:i}),ne.jsx(fR,{user:o,handleSignIn:e,handleCreateAccount:t,handleChange:s})]})})}const Tu=(i,e)=>{const{id:t,value:s}=i.target;e(o=>({...o,[t]:s}))},gR=(i,e)=>{i(t=>({...t,[e]:!t[e]}))},yR=(i,e,t)=>{const s=i.target.id;_R(e,s),t(i.target.id.slice(5))},_R=(i,e)=>{i(t=>t.map(s=>s.id===e?{...s,selected:"selected-emoji"}:{...s,selected:"unselected-emoji"}))},vR=(i,e)=>{i(t=>t.map(s=>({...s,selected:""}))),e("")},ER=i=>{const e=i.toDate(),t=e.getDate(),s=e.getFullYear(),u=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][e.getMonth()];let h=e.getHours(),f=e.getMinutes();return h=h<10?"0"+h:h,f=f<10?"0"+f:f,`${t} ${u} ${s} - ${h}:${f}`},wR=i=>i.split(/\n/g).map((e,t)=>ne.jsxs(ne.Fragment,{children:[e,ne.jsx("br",{},t)]}));function TR(){const[i,e]=ln.useState({name:"",email:"",password:"",photoURL:"./images/default-profile-picture.jpeg",errorMessage:"",successMessage:""}),[t,s]=ln.useState([]),[o,u]=ln.useState(""),[h,f]=ln.useState({body:""}),[g,v]=ln.useState({show:!1,id:"",body:""}),[w,C]=ln.useState({name:"",photoURL:""}),[x,j]=ln.useState([{name:"Awful",imgUrl:"./emojis/1.png",id:"mood-1",selected:""},{name:"Bad",imgUrl:"./emojis/2.png",id:"mood-2",selected:""},{name:"Meh",imgUrl:"./emojis/3.png",id:"mood-3",selected:""},{name:"Good",imgUrl:"./emojis/4.png",id:"mood-4",selected:""},{name:"Amazing",imgUrl:"./emojis/5.png",id:"mood-5",selected:""}]),[G,Q]=ln.useState(JSON.parse(localStorage.getItem("filterBtns"))||[{id:"today-filter-btn",value:"Today",selected:""},{id:"week-filter-btn",value:"Week",selected:""},{id:"month-filter-btn",value:"Month",selected:""},{id:"all-filter-btn",value:"All",selected:""}]),[$,fe]=ln.useState(!1);ln.useEffect(()=>iR(e,fe,s,Q,G),[]),ln.useEffect(()=>{localStorage.setItem("filterBtns",JSON.stringify(G))},[G]);const pe=async D=>{D.preventDefault(),await oR(i,e)},ge=async D=>{D.preventDefault(),await aR(i,e)},we=()=>{lR(e),C({name:"",photoURL:""})},Fe=async()=>{await sR(e)},Te=()=>{uR(e,w),C({name:"",photoURL:""})},N=async()=>{await XA(h,f,o),vR(j,u)},I=async D=>{await JA(D)},A=async()=>{g.id&&(await ZA(g.id,g.body),R(" "," "))},R=(D,S)=>{gR(v,"show"),v(Ye=>({...Ye,id:D,body:S}))},V=(D,S)=>{Iv(D.target.id,S,s)};return ne.jsx("main",{id:"App",children:$?ne.jsx(dR,{user:i,onSignOut:we,updatedUser:w,handleUpdateProfile:Te,handleUpdateProfileChange:D=>Tu(D,C),handleNewPostChange:D=>Tu(D,f),handleAddPost:N,handleDeletePost:I,handleUpdatePost:A,handleUpdatePostChange:D=>Tu(D,v),newPost:h,posts:t,editingPost:g,updateEditingPost:R,mood:x,handleMoodClick:D=>yR(D,j,u),displayFormatedDate:ER,replaceNewLines:wR,filterBtns:G,handleFilterBtnClick:D=>V(D,Q)}):ne.jsx(mR,{onGoogleSignIn:Fe,user:i,handleSignIn:pe,handleCreateAccount:ge,handleChange:D=>Tu(D,e)})})}L0.createRoot(document.getElementById("root")).render(ne.jsx(ln.StrictMode,{children:ne.jsx(TR,{})}));
